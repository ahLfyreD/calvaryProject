...
import LeadPastor from '../../assets/images/PastorPapa.jpg'
                ...
                <div className="w-full p-5 max-w-6xl mx-auto">
                    ...
                    <div className='mx-auto w-full flex flex-wrap gap-3 m-auto justify-between items-center' >
                        <div className='mx-auto rounded-lg w-[300px] p-5 flex flex-col items-center justify-around'>
                            ...
                            <div>
                                <h2 className='text-lg text-center'>Pastor Gabriel</h2>
                                <p className='text-center'>Pastor Gabriel is an Administrative and Pastoral care director at Calvary Family Church</p>
                            </div>
